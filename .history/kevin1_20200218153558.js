    ...
    questions:[
        {
            ...
            answer:"b",
            bgcolor:"yellow",
            img:"httml://placekitten.com/100/100"
        ...
        },
        {
            ...
            answer:"yes",
            bgcolor:"#ABC",
            img:"httml://placekitten.com/100/200"
        },
        {
            title:"What is the color of a banana?",
            answer:"yellow",
            bgcolor:"rgb(2,150,222)",
            img:"httml://placekitten.com/100/300"
        }
    ]
}
...
function checkAnswer(){
    ...
    document.querySelector("#question").innerHTML = "<img src='" + data.questions[data.qnum].img+"' />";
